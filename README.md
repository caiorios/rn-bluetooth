...
## Installation
1. Install package via npm: `npm i -S rn-bluetooth`
...
## Manual installation
#### iOS
1. `npm i -S rn-bluetooth`
2. In XCode, in the project navigator, right click `Libraries` ➜ `Add Files to [your project's name]`
3. Go to `node_modules` ➜ `rn-bluetooth` and add `RCTBluetoothSerial.xcodeproj`
...
3. Append the following lines to `android/settings.gradle`:
    ```
    include ':rn-bluetooth'
    project(':rn-bluetooth').projectDir = new File(rootProject.projectDir, '../node_modules/rn-bluetooth/android')
    ```
4. Insert the following lines inside the dependencies block in `android/app/build.gradle`:
    ```
    compile project(':rn-bluetooth')
    ```
...
1. `git clone https://github.com/caiorios/rn-bluetooth.git`
2. `cd rn-bluetooth/BluetoothSerialExample`
3. `npm i`
